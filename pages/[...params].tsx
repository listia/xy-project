...
function Home() {
  ...
  const x = (zoomParamsInt[1] || zoomParamsInt[1] == 0) && 0 <= zoomParamsInt[1] && zoomParamsInt[1] <= 127 ? zoomParamsInt[1] : null;
  const y = (zoomParamsInt[2] || zoomParamsInt[2] == 0) && 0 <= zoomParamsInt[2] && zoomParamsInt[2] <= 127 ? zoomParamsInt[2] : null;
