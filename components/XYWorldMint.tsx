...
const XYWorldMint = ({ contract, handleReload }) => {
  ...
  return (
    <div className="items-center text-center pt-3">
      A maximum of 2,500 Limited Edition X,Y World NFTs are available.
      <br/><br/>
      Allowlist-only until Sept. 10th 16:00 UTC
      <br/><br/>
      Only <a href="https://opensea.io/collection/xy-coordinates">X,Y Project</a> owners can mint. Your wallet X,Y Coordinates will show up below.
      <br/><br/>
      Limited Edition Price: <b>0.05 ETH</b>
      <br/><br/>
      (Free Base Editions will be available a few days after the Public Sale starts.)
      <br/><br/>
      {isConnected && (
